...
namespace TLCService.BinaryClassification
{
    ...
    {
        protected Dictionary<string, PredictionEngine<ICExample, BCScoredData>> predictionEngineDict;
        protected Dictionary<string, BCVSMConvertor> convertorDict;

        protected HashSet<string> PositiveLabels;
        protected string NegtiveLabelString;                
        ...
        public virtual ICTextPredictionInfo Predict(string Utterance, string EdiResult)
        {
        ...
        protected ICTextPredictionInfo SingleModelPredict(string PositiveLabel, string Utterance, string EdiResult)
        {
