...
namespace Bot.Classifier.Binaryclassification.AlgorithmExecutor
{
    public class TLCBCTrainer
    {
        //private CutterType[] types = { CutterType.NGRAM };
        //private BCVSMConvertor convertor;
       /* public TLCBCTrainer(ModelFilePathInfo vsmodelfilepath)
        {
            this.convertor = new BCVSMConvertor(vsmodelfilepath);
        }

        public TLCBCTrainer(ClassificationVSMInfo model)
        {
            this.convertor = new BCVSMConvertor(model);
        }*/
